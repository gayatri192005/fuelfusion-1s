...
interface Vehicle {
  ...
  type: string
  driver: string
  fuelLevel: number // litres currently in tank
...
function fuelTextColor(level: number, capacity: number) {
              ...
              {vehicles.map((v) => (
                <tr key={v.id} className="border-b last:border-b-0 even:bg-gray-50">
                  ...
                  <td className="p-3 text-center">
                    <span className={cn("font-semibold", fuelTextColor(v.fuelLevel, v.fuelCapacity))}>
